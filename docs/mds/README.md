...
Documentação detalhada de cada etapa do projeto de mapeamento das pastagens no estado de Santa Catarina para o ano de 2024, baseada no ATBD (Algorithm Theoretical Basis Document).
...
| 5 | [Estratégias de Refinamento](./05_refinamento.md) | `05_refinamento.md` |
...
- [Mapa Final](https://polianavi.github.io/pastagem_remap/)
