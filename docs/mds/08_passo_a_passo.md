...
[//]:#(imagem_metodologia)
<div align="center">
    <img src="../images/Metodologia_Pastagens_SC.png" width="85%" alt="Processo de Operacionalização">
...
[//]:#(imagem_chave_interpretacao)
<div align="center">
    <img src="../images/interpretacao_pastagem.png" width="75%" alt="Chave de interpretação">
    <p><i>Figura 2: Chave de interpretação realizada.</i></p>
</div>
<br>
...
<div align="center">
    <img src="../images/tvi.png" width="85%" alt="interface">
    <p><i>Figura 3: Interface de login do programa Temporal Visual Inspection (TVI).</i></p>
</div>
<br>
<div align="justify"> 
...
## Classificação
<div align="center">
    <img src="../images/Classificacoes_realizadas.png" width="85%" alt="classificacoes">
    <p><i>Figura 4: Classificações testadas.</i></p>
</div>
<br>
<div align="justify"> 
    A metodologia realizada pelo mapbiomas de classificação de áreas de pastagem foi adaptanda pois a possibilidade de classificar áreas de pastagem naturais e pastagens cultivadas foi explorada em testes (representados na figura 4). A classificação binária que separava as classes de todas as pastagens por outros foi a mais correspondente com a realidade, sendo essa feita em 2 etapas, apontadas nos scripts abaixo:
    <ul>
        <li><a href="../base_dados/aplicacao/Scripts/Classificacao.js"> Classificação binária </a> (GEE JavaScript)</li>
        <li><a href="../base_dados/aplicacao/Scripts/Filtro_moda_mediana.js"> Filtro de moda com kernel 5x5 </a> (GEE JavaScript)</li>
    </ul>
</div>
<br>
...
<div align="center">
    <img src="../images/divisao_regioes.png" width="65%" alt="classificacoes">
    <p><i>Figura 5: Início de divisões de regiões para refinamento e auditoria.</i></p>
</div>
<br>
<div align="justify"> 
    ...
    <ul>
        <li><a href="../base_dados/aplicacao/Scripts/recorte_automatizado.sh"> Scripts Automatizados de Recorte </a> (.sh)</li>
        <li><a href="../base_dados/aplicacao/Scripts/uniao_de_dados.sh"> Scripts de União de Dados </a> (.sh)</li>
    </ul>
</div>
<br>
...
<div align="center">
    <img src="../images/fluxograma_codigos.png" width="85%" alt="classificacoes">
    <p><i>Figura 6: Fluxograma de processamento de dados.</i></p>
</div>
<br>
<div align="justify"> 
