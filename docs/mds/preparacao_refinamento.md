...
## Preparação dos Dados (Pipeline via Shell)
...
**Etapa anterior:** [Processamento e Classificação](./processamento_classificacao.md)  
**Próxima etapa:** [Análise do Mapeamento](./analise_mapeamento.md)
